...
Source0  : http://download.osgeo.org/proj/proj-6.1.1.tar.gz
...
%prep
%setup -q -n proj-6.1.1
pushd ..
cp -a proj-6.1.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1562053117
...
/usr/lib64/haswell/libproj.so.15.1.1
/usr/lib64/libproj.so.15
/usr/lib64/libproj.so.15.1.1
