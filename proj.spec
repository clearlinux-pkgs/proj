...
Version  : 7.1.0
Release  : 14
URL      : http://download.osgeo.org/proj/proj-7.1.0.tar.gz
Source0  : http://download.osgeo.org/proj/proj-7.1.0.tar.gz
...
%prep
%setup -q -n proj-7.1.0
cd %{_builddir}/proj-7.1.0
pushd ..
cp -a proj-7.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1597335003
...
cp %{_builddir}/proj-7.1.0/COPYING %{buildroot}/usr/share/package-licenses/proj/ff8d569976b75bad2e71d78ad1df7a422f1165c9
pushd ../buildavx2/
%make_install_avx2
popd
%make_install
...
/usr/lib64/haswell/libproj.so.19.1.0
/usr/lib64/libproj.so.19
/usr/lib64/libproj.so.19.1.0
