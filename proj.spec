...
Version  : 8.0.0
Release  : 18
URL      : http://download.osgeo.org/proj/proj-8.0.0.tar.gz
Source0  : http://download.osgeo.org/proj/proj-8.0.0.tar.gz
...
%prep
%setup -q -n proj-8.0.0
cd %{_builddir}/proj-8.0.0
pushd ..
cp -a proj-8.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614624104
...
cp %{_builddir}/proj-8.0.0/COPYING %{buildroot}/usr/share/package-licenses/proj/446797413e339410c98efdd33a006d5a4785fe1a
pushd ../buildavx2/
%make_install_avx2
popd
%make_install
...
/usr/lib64/haswell/libproj.so.22.0.0
/usr/lib64/libproj.so.22
/usr/lib64/libproj.so.22.0.0
